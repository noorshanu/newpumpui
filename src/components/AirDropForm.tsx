...
const AirDropForm = () => {
  ...
  return (
    <div className="w-full mx-auto p-4 shadow-lg bg-[#ffffff0e]  border border-[#B7B6BB26] backdrop-blur-lg rounded-lg ">
      ...
      <div className="flex flex-col sm:flex-row gap-4  mb-6 items-center">
        ...
        <div className=" w-full sm:w-1/2">
          <label className="block text-white ">Quantity per Wallet</label>
          <input 
            type="number" 
      ...
      <div className="border border-gray-500 p-4 mb-6 rounded-lg">
        <h4 className="font-semibold text-white mb-2">* List of Wallet Addresses:</h4>
    ...
    <label className="block text-white  ">Add New Wallet Wallet</label>
        <input
          type="text"
      ...
      {/* Summary Section */}
      <div className="flex justify-between gap-4 text-white  mb-6">
