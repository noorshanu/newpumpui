...
<>
<DefaultLayout>
<div className=" p-4 sm:max-w-7xl mx-auto px-2 mt-8">
      <div>
        <h2 className="text-2xl font-bold mb-4 ">Wallet List</h2>
      </div>
      <div className=" flex justify-center gap-4  ">
        <SetWalletType />
        <div className=" flex flex-col  gap-4  mt-2 w-full shadow-lg bg-[#ffffff0e]  border border-[#B7B6BB26] backdrop-blur-lg ">
